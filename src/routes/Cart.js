    ...
    <div>
      ...
      <div className="text-container">
        ...
        <div className="btn-container">
          <i className="fa-solid icon-with-margin" onClick={handleclick}>Want More</i>
          <i class="fa-solid icon-margin" onClick={handleOrder}>Pay Now</i>
        </div>
      </div>
      {cart.length === 0 ? (
        <div>
          <h1 className="text padd">No Item in cart!</h1>
        </div>
      ) : cart?.map((food_cart) => (
